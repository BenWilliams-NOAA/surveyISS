...
#' calculate age comp input sample size and add nominal sample size and number of sampled hauls to output for subregions
#'
#' @param rss_age iterated realized sample size
#' @param specimen_data input dataframe
#' @param survey_region overall region (e.g., 'goa' or 'ai')
#'
#' @return
#' @export iss_age_reg
#'
#' @examples
iss_age_reg <- function(rss_age,
                        specimen_data,
                        survey_region) {
...
#' calculate bias in bootstrapped age comp for subregion level
#'
#' @param r_age iterated age pop'n
#' @param oga original age comps without any sampling
#'
...
#' calculate mean length-at-age and sd at subregion level
#'
#' @param r_age iterated age pop'n
#' @param oga original age comps without any sampling
#'
#' @return
#' @export grwth_stats_reg
#'
#' @examples
grwth_stats_reg <- function(r_age,
                            oga) {
...
#' calculate length comp input sample size and add nominal sample size and number of sampled hauls to output at subregion level
#'
#' @param rss_length iterated realized sample size
#' @param lfreq_data input dataframe
#' @param survey_region scale of survey region (e.g., 'goa' or 'ai')
#'
#' @return
#' @export iss_length_reg
#'
#' @examples
iss_length_reg <- function(rss_length,
                           lfreq_data,
                           survey_region) {
...
#' calculate bias in bootstrapped length comp at subregion level
#'
#' @param r_length iterated length pop'n
#' @param ogl original length comps without any sampling
#'
#' @return
#' @export bias_length_reg
#'
#' @examples
bias_length_reg <- function(r_length,
                            ogl) {
...
#' calculate age comp input sample size and add nominal sample size and number of sampled hauls to output for complexes
#'
#' @param rss_age iterated realized sample size
#' @param specimen_data input dataframe
#'
#' @return
#' @export iss_age_cmplx
#'
#' @examples
iss_age_cmplx <- function(rss_age,
                          specimen_data) {
...
#' calculate bias in bootstrapped age comp for complexes
#'
#' @param r_age iterated age pop'n
#' @param oga original age comps without any sampling
#'
#' @return
#' @export bias_age_cmplx
#'
#' @examples
bias_age_cmplx <- function(r_age,
                           oga) {
...
#' calculate length comp input sample size and add nominal sample size and number of sampled hauls to output for complexes
#'
#' @param rss_length iterated realized sample size
#' @param lfreq_data input dataframe
#'
#' @return
#' @export iss_length_cmplx
#'
#' @examples
iss_length_cmplx <- function(rss_length,
                             lfreq_data) {
...
#' calculate bias in bootstrapped length comp for complexes
#'
#' @param r_length iterated length pop'n
#' @param ogl original length comps without any sampling
#'
#' @return
#' @export bias_length_cmplx
#'
#' @examples
bias_length_cmplx <- function(r_length,
                              ogl) {
...
#' calculate mean length-at-age and sd for complexes
#'
#' @param r_age iterated age pop'n
#' @param oga original age comps without any sampling
#'
#' @return
#' @export grwth_stats_cmplx
#'
#' @examples
grwth_stats_cmplx <- function(r_age,
                            oga) {
